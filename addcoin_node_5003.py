...
#part 1: adding transactions and consenses to blockchain
class Blockchain:
    def __init__(self):
        self.chain = []
        self.transactions = []
...
def mine_block():
    ...
    transactions = blockchain.add_transaction(sender = node_address, receiver = 'Shashank', amount=1)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The addcoin Blockchain now contains the following nodes:',
